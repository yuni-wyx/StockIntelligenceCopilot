          ...
          <div className="mt-4 space-y-4">
            <Field label={copy.sellTicker}>
              <input
                ...
                onChange={(e) =>
                  onScenarioFormChange((prev) => ({ ...prev, sellTicker: e.target.value }))
                }
                placeholder="00878"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <Field label={copy.sellShares}>
                <input
                  ...
                  onChange={(e) =>
                    onScenarioFormChange((prev) => ({ ...prev, sellShares: e.target.value }))
                  }
                  inputMode="decimal"
            ...
            <Field label={copy.buyTicker}>
              <input
                ...
                onChange={(e) =>
                  onScenarioFormChange((prev) => ({ ...prev, buyTicker: e.target.value }))
                }
                placeholder="2330"
                className={inputClassName}
              />
            ...
            <Field label={copy.buyAmount}>
              <input
                ...
                onChange={(e) =>
                  onScenarioFormChange((prev) => ({ ...prev, buyAmount: e.target.value }))
                }
                inputMode="decimal"
                placeholder="35000"
                className={inputClassName}
            ...
            <Field label={copy.buyName}>
              <input
                ...
                onChange={(e) =>
                  onScenarioFormChange((prev) => ({ ...prev, buyName: e.target.value }))
                }
            ...
            <Field label={copy.scenarioQuestion}>
              <textarea
                ...
                onChange={(e) =>
                  onScenarioFormChange((prev) => ({ ...prev, question: e.target.value }))
                }
                rows={5}
                    ...
                    <div className="mt-3 grid gap-3 md:grid-cols-3">
                      ...
                      {needsPercentage ? (
                        <Field label={copy.sellPercentage}>
                          <input
                            ...
                            onChange={(e) =>
                              onUpdateComparisonScenario(scenarioItem.id, "percentage", e.target.value)
                            }
                            inputMode="decimal"
                            placeholder="50"
                            className={inputClassName}
                        ...
                        <Field label={copy.buyAmount}>
                          <input
                            ...
                            onChange={(e) =>
                              onUpdateComparisonScenario(scenarioItem.id, "amount", e.target.value)
                            }
                            inputMode="decimal"
                            placeholder="35000"
                            className={inputClassName}
                      ...
                      <Field label={copy.question}>
                        <input
                          ...
                          onChange={(e) =>
                            onUpdateComparisonScenario(scenarioItem.id, "question", e.target.value)
                          }
